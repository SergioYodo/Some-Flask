...
DEBUG = True
SECRET_KEY = 'bdsjkhfcuihglkjnxiu876qjsdlkam'

app = Flask(__name__)
# app.config['SECRET_KEY'] = 'bdsjkhfcuihglkjnxiu876qjsdlkam'
...
menu=dbase.get_menu(), posts=dbase.get_posts_announce())
